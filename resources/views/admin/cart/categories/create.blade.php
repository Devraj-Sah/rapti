    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                {{ Form::open(['route'=>'product-categories.store','method'=>'post', 'enctype'=>'multipart/form-data']) }}
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-9" style="padding-top: 10px;">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" min="0"
                                   class="form-control {{ $errors->has('position') ? 'has-error' : '' }}"
                                   name="position" id="position" required="required" value="{{$next_position}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9" style="padding-top: 10px;">
                        <div class="form-group col-md-2">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="side_banner" id="side_banner"
                                       value="1">
                        ...
                        <div class="form-group col-md-2">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="feature" id="feature" value="1">
