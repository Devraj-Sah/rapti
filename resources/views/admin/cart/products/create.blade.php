            ...
            <div class="box-header with-border">
                ...
                <div class="row">
                    <div class="col-md-9" style="padding-top: 10px;">
                        <div class="form-group col-md-10">
                            ...
                            {{ Form::select('category_id',['Select']+$categories->toArray(),null,['class' => 'form-control required']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-9" style="padding-top: 10px;">
                        <div class="form-group col-md-10">
                            ...
                            <label><input type="checkbox" name="featured_products" value="1"> Featured Products</label>
                            <label><input type="checkbox" name="popular_product" value="1"> Popular Product</label>
                            <label><input type="checkbox" name="hot_deal" value="1"> Hot Deal</label>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="padding-top: 10px;">
                        <div class="form-group col-md-10">
                            ...
                            {{ Form::text('color_code',null,['class' => 'form-control required']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {{ Form::text('compare_price',null,['class' => 'form-control']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-12">
                        <div id="short_content_div" class="form-group col-md-12">
                            ...
                            <textarea class="form-control ckeditor" id="short_content" name="short_desc" rows="5"
                                      placeholder="Short Content">{{old('short_desc')}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                 ...
                 <div class="form-group col-md-12">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" type="text" id="meta_title" name="meta_title" placeholder="Page Title" value="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="meta_keywords">Page Keywords</label>
                        <input class="form-control" type="text" id="meta_keywords" name="meta_keywords" placeholder="Page Keywords" value="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="meta_description">Page Description</label>
                        <input class="form-control" type="text" id="meta_description" name="meta_description" placeholder="Page Description" rows="3" style="resize: none;">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-9">
